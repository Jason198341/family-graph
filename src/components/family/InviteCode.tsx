  ...
  return (
    <div className="bg-surface border border-surface-border rounded-xl p-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          onClick={handleCopy}
          className="px-3 py-2 bg-surface-light border border-surface-border rounded-lg text-xs text-gray-600 hover:text-gray-900 hover:border-gray-400 transition-colors cursor-pointer shrink-0"
        >
          {copied ? '복사됨!' : '복사'}
        </button>
      </div>
      {onRegenerate && (
        <button
          ...
          className="mt-2 text-xs text-gray-500 hover:text-gray-700 transition-colors cursor-pointer disabled:opacity-50"
        >
