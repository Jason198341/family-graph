      ...
      <div className="w-full max-w-sm mx-4 text-center animate-fade-in-up">
        ...
        <div className="flex gap-3 justify-center">
          <button
            ...
            className="px-4 py-2 bg-surface-light border border-surface-border rounded-lg text-sm text-gray-300 hover:text-white hover:border-gray-500 transition-colors cursor-pointer"
          >
            새로고침
          </button>
          <button
            onClick={handleLogout}
            className="px-4 py-2 text-sm text-gray-500 hover:text-gray-300 transition-colors cursor-pointer"
          >
            로그아웃
          </button>
        </div>
